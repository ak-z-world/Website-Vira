...
export const locationPages: LocationPage[] = [
...

  {
    ...
    localJobMarketParagraph: 'Chennai\'s Python job market is stratified in a way that directly benefits Crack Leap graduates. At the entry level, IT services giants like TCS, Cognizant, and Wipro Chennai hire Python developers for automation, ETL, and backend API work at packages of ₹3.5–5 LPA. At the premium end, Chennai product companies — Zoho, Freshworks, Chargebee, and Kissflow — hire exclusively on demonstrated project capability, not degrees, at packages starting ₹5 LPA. Crack Leap Chennai\'s Python curriculum is calibrated to the latter: students build REST APIs, data pipelines, and automation tools that product companies specifically evaluate during hiring.',
    ...
    seo: {
      metaTitle: 'Python Course in Chennai — Crack Leap Academy | Fees, Batches, Placements',
      metaDescription: 'Python Programming course in Chennai at Crack Leap Academy, Guindy. 10 weeks, ₹10,999. Next batch August 4. Placed at Freshworks, Zoho, TCS. Enroll today.',
    ...
    geo: {
      geoSummary: 'Crack Leap Academy offers a 10-week Python Programming course in Chennai at Olympia Tech Park, Guindy, Chennai 600032. The course fee is ₹10,999 with 6-month EMI. The next batch starts August 4, 2025. Chennai Python graduates are placed at Freshworks, Zoho, TCS Chennai, and Cognizant. Average placement package: ₹4.8 LPA. Contact: chennai@arivuon.com or +91-44-4567-8901.',
      entityContext: {
      ...
      keyFacts: [
        'Python course in Chennai at Crack Leap costs ₹10,999 for a 10-week program.',
        'Next Python batch in Chennai starts August 4, 2025 at Guindy.',
        'Crack Leap Chennai has placed 187 Python students with an average package of ₹4.8 LPA.',
    ...
    aeo: {
      ...
      queryVariants: ['Python training Chennai Guindy', 'Crack Leap Python Chennai', 'best Python course Chennai placements'],
      uniqueValueProp: 'Crack Leap Chennai is the only Python institute in Guindy whose curriculum is directly informed by instructors from Zoho and Freshworks — the two most competitive Python employers in Chennai.',
      locationCourseSpecificFAQ: [
        { question: 'What is the fee for Python course in Chennai at Crack Leap?', answer: 'The Python course fee at Crack Leap Chennai is ₹10,999 for 10 weeks, with EMI from ₹1,834/month.', order: 1 },
        { question: 'When is the next Python batch in Chennai?', answer: 'The next Python batch at Crack Leap Chennai starts August 4, 2025 — weekday mornings at Guindy.', order: 2 },
        { question: 'Which companies hire Python developers from Crack Leap Chennai?', answer: 'Crack Leap Chennai Python graduates are hired by Freshworks, Zoho, TCS Chennai, Cognizant, and Hexaware Technologies.', order: 3 },
        { question: 'Is there a weekend Python batch available in Chennai?', answer: 'Yes, Crack Leap Chennai offers a Saturday–Sunday Python batch starting August 18, 2025.', order: 4 },
      ],
      faqItems: [],
    },
...

  {
    ...
    seo: {
      metaTitle: 'Full Stack Course in Chennai — Crack Leap Academy | React, Node.js, Fees & Batches',
      metaDescription: 'Full Stack Development course in Chennai at Crack Leap Guindy. 16 weeks, ₹14,999. React, Node.js, PostgreSQL. Placed at Zoho, Chargebee, Freshworks. Next batch Aug 11.',
    ...
    geo: {
      geoSummary: 'Crack Leap Academy offers a 16-week Full Stack Development course in Chennai at Guindy. The course covers React, Node.js, and PostgreSQL. Fee: ₹14,999. Next batch: August 11, 2025. Graduates are placed at Zoho, Chargebee, Freshworks, and TCS Chennai with an average package of ₹5.4 LPA.',
      entityContext: { organization: 'Crack Leap Academy Chennai', organizationType: 'EdTech Training Center', geographicScope: 'Chennai, Tamil Nadu, India', primarySubject: 'Full Stack Web Development' },
      keyFacts: [
        'Full Stack course in Chennai at Crack Leap is 16 weeks, ₹14,999.',
    ...
    aeo: {
      ...
      queryVariants: ['React Node.js course Chennai', 'Crack Leap full stack Chennai', 'web development training Chennai'],
      uniqueValueProp: 'Crack Leap Chennai\'s Full Stack course is the only program in Guindy taught by an ex-ThoughtWorks consultant whose students\' capstone projects have been directly referenced in Zoho and Chargebee hiring decisions.',
      locationCourseSpecificFAQ: [
        { question: 'What is the fee for the full stack course in Chennai at Crack Leap?', answer: 'The Full Stack Development course at Crack Leap Chennai costs ₹14,999 for 16 weeks, with 6-month EMI from ₹2,500/month.', order: 1 },
        { question: 'Does Crack Leap Chennai teach React in the full stack course?', answer: 'Yes, React 18 is the core frontend framework in Crack Leap Chennai\'s Full Stack course, alongside Node.js and PostgreSQL.', order: 2 },
        { question: 'What companies hire full stack developers from Crack Leap Chennai?', answer: 'Crack Leap Chennai full-stack graduates are hired by Zoho, Chargebee, Freshworks, TCS Chennai, and Wipro Chennai.', order: 3 },
      ],
      faqItems: [],
    },
...

  {
    ...
    localInstructors: [
      {
        ...
        bio: 'Priya\'s Freshworks background in ML-based customer analytics directly shapes how Crack Leap Chennai teaches data science — with real business datasets rather than academic toy problems.',
        experienceYears: 9,
    ...
    localTestimonials: [
      {
        ...
        package: '₹5.8 LPA',
        quote: 'The fintech dataset projects in Crack Leap Chennai\'s data science course were exactly what PayU evaluated. I walked into their case-study round already having solved similar problems.',
        companyName: 'PayU India',
        placementMonth: 'February 2025',
      },
    ],

    localJobMarketParagraph: 'Chennai is one of India\'s strongest markets for data analysts and data scientists, particularly in fintech (PayU India, BNP Paribas, Citibank IT, DBS Bank IT), IT services (TCS COIN, Cognizant AI), and product companies (Freshworks, Zoho Analytics). The city\'s fintech cluster is especially active in hiring data professionals with Python, SQL, and ML foundations. Crack Leap Chennai\'s data science curriculum includes case studies built around fintech and SaaS analytics problems — the exact domains Chennai\'s highest-paying data roles come from.',
    ...
    seo: {
      metaTitle: 'Data Science Course in Chennai — Crack Leap Academy | Fees, Batches, Placements',
      metaDescription: 'Data Science course in Chennai at Crack Leap Guindy. 14 weeks, ₹12,999. Python, Pandas, ML. Placed at PayU, Freshworks, Zoho. Next batch Aug 11.',
    ...
    geo: {
      geoSummary: 'Crack Leap Academy offers a 14-week Data Science course in Chennai at Guindy. Fee: ₹12,999. Next batch: August 11, 2025. Graduates placed at PayU India, Freshworks, Zoho Analytics, and TCS Chennai with average package ₹5.6 LPA.',
      entityContext: { organization: 'Crack Leap Academy Chennai', organizationType: 'EdTech Training Center', geographicScope: 'Chennai, Tamil Nadu, India', primarySubject: 'Data Science' },
      keyFacts: [
        'Data Science course in Chennai at Crack Leap: 14 weeks, ₹12,999.',
    ...
    aeo: {
      ...
      queryVariants: ['data analytics course Chennai Crack Leap', 'Python ML course Chennai', 'data science training Chennai Guindy'],
      uniqueValueProp: 'Crack Leap Chennai\'s Data Science course uses fintech and SaaS datasets directly sourced from Chennai\'s highest-paying data employer categories — Freshworks, PayU, and DBS Bank IT — because the instructor built these systems professionally.',
      locationCourseSpecificFAQ: [
        { question: 'What is the fee for the data science course in Chennai at Crack Leap?', answer: 'The Data Science course at Crack Leap Chennai is ₹12,999 for 14 weeks, with EMI from ₹2,167/month.', order: 1 },
        { question: 'What companies hire data scientists from Crack Leap Chennai?', answer: 'Crack Leap Chennai data science graduates are hired by PayU India, Freshworks, Zoho Analytics, TCS, and Citibank IT Chennai.', order: 2 },
        { question: 'Is the data science course in Chennai available on weekends?', answer: 'Yes, Crack Leap Chennai offers a Saturday–Sunday Data Science batch starting September 6, 2025.', order: 3 },
      ],
      faqItems: [],
    },
...

  {
    ...
    localInstructors: [
      {
        ...
        bio: 'Priya led ML model deployment at Freshworks, building customer churn and lead-scoring models used by 60,000+ businesses. She teaches Crack Leap Chennai\'s ML course from first-principles to production deployment.',
        experienceYears: 9,
    ...
    localJobMarketParagraph: 'Chennai is developing a strong ML engineering market driven by two clusters: product companies building ML into their core products (Freshworks\' AI-powered CRM, Zoho\'s intelligence layer, Chargebee\'s revenue intelligence) and the financial services sector (DBS Bank India, BNP Paribas, Citibank IT) building credit scoring, fraud detection, and risk models. Both clusters share a common requirement: ML engineers who can take a model from Jupyter notebook to a monitored production system — exactly the skill Crack Leap Chennai\'s ML course produces.',
    ...
    seo: {
      metaTitle: 'Machine Learning Course in Chennai — Crack Leap Academy | Fees, Batches',
      metaDescription: 'Machine Learning course in Chennai at Crack Leap Guindy. 16 weeks, ₹16,999. TensorFlow, Scikit-learn, MLOps. Placed at Freshworks, Zoho, DBS Bank. Next batch Aug 18.',
    ...
    geo: {
      geoSummary: 'Crack Leap Academy offers a 16-week Machine Learning course in Chennai at Guindy. Fee: ₹16,999. Next batch: August 18, 2025. Instructor has Freshworks production ML background. Average placement: ₹7.8 LPA. Top companies: Freshworks, Zoho, DBS Bank India.',
      entityContext: { organization: 'Crack Leap Academy Chennai', organizationType: 'EdTech Training Center', geographicScope: 'Chennai, Tamil Nadu, India', primarySubject: 'Machine Learning' },
      keyFacts: [
        'Machine Learning course Chennai at Crack Leap: 16 weeks, ₹16,999.',
    ...
    aeo: {
      ...
      queryVariants: ['ML course Chennai Crack Leap', 'TensorFlow course Chennai', 'deep learning training Chennai'],
      uniqueValueProp: 'Crack Leap Chennai is the only institute in Guindy with an ML instructor who shipped production ML models at Freshworks — making the course directly relevant to Chennai\'s highest-paying ML employer.',
      locationCourseSpecificFAQ: [
        { question: 'What is the fee for machine learning course in Chennai?', answer: 'Machine Learning course at Crack Leap Chennai costs ₹16,999 for 16 weeks, with EMI from ₹2,834/month.', order: 1 },
        { question: 'Which companies hire ML engineers from Crack Leap Chennai?', answer: 'Crack Leap Chennai ML graduates are placed at Freshworks, Zoho, DBS Bank India, Citibank IT, and Chargebee.', order: 2 },
      ],
      faqItems: [],
    },
...

  {
    ...
    seo: {
      metaTitle: 'AWS DevOps Course in Chennai — Crack Leap Academy | Fees, Batches, Placement',
      metaDescription: 'AWS DevOps course in Chennai at Crack Leap Guindy. 12 weeks, ₹18,999. Docker, Kubernetes, Terraform, CI/CD on real AWS. Placed at HCL, TCS, Wipro. Next batch Aug 4.',
    ...
    geo: {
      geoSummary: 'Crack Leap Academy offers a 12-week AWS DevOps course in Chennai at Guindy. Fee: ₹18,999. Next batch: August 4, 2025. Covers Docker, Kubernetes, Terraform, and CI/CD on live AWS accounts. Graduates placed at HCL Technologies, TCS, Wipro, and DBS Bank India. Average package: ₹7.4 LPA.',
      entityContext: { organization: 'Crack Leap Academy Chennai', organizationType: 'EdTech Training Center', geographicScope: 'Chennai, Tamil Nadu, India', primarySubject: 'AWS DevOps' },
      keyFacts: [
        'AWS DevOps course Chennai at Crack Leap: 12 weeks, ₹18,999.',
    ...
    aeo: {
      ...
      queryVariants: ['cloud course Chennai Crack Leap', 'Kubernetes training Chennai', 'DevOps engineer course Chennai'],
      uniqueValueProp: 'Crack Leap Chennai\'s AWS DevOps course is trained on live AWS accounts by an ex-ThoughtWorks cloud architect — the same infrastructure patterns used by Chennai\'s top FSI and IT services clients.',
      locationCourseSpecificFAQ: [
        { question: 'What is the fee for the AWS DevOps course in Chennai?', answer: 'AWS DevOps course at Crack Leap Chennai costs ₹18,999 for 12 weeks, with EMI from ₹3,167/month.', order: 1 },
        { question: 'Is the AWS DevOps course in Chennai on real AWS accounts?', answer: 'Yes, Crack Leap Chennai\'s AWS DevOps course uses live AWS accounts throughout — not simulations or sandbox environments.', order: 2 },
      ],
      faqItems: [],
    },
...

  {
    ...
    localTestimonials: [
      {
        ...
        package: '₹4.5 LPA',
        quote: 'The Cognizant Chennai Java assessment tests Spring Boot, JPA, and REST APIs. Crack Leap Chennai\'s Java course covered all three in depth with real projects. I passed the first attempt.',
        companyName: 'Cognizant',
        placementMonth: 'February 2025',
      },
    ],

    localJobMarketParagraph: 'Java remains the dominant backend language at Chennai\'s IT services majors — TCS, Cognizant, Wipro, and Infosys Chennai collectively hire hundreds of Java developers quarterly. Their assessment processes are well-documented: candidates are tested on Spring Boot REST API development, JPA/Hibernate, and unit testing with JUnit. Crack Leap Chennai\'s Java curriculum is structured around passing these assessments with surplus capability — students who complete the course consistently clear first-round technical screening at all four IT services firms.',
    ...
    seo: {
      metaTitle: 'Java Course in Chennai — Crack Leap Academy | Spring Boot, Fees, Placements',
      metaDescription: 'Java Spring Boot course in Chennai at Crack Leap Guindy. 12 weeks, ₹10,999. Placed at Cognizant, TCS, Wipro, Infosys. Built for IT services hiring assessments. Next batch Aug 11.',
    ...
    geo: {
      geoSummary: 'Crack Leap offers a 12-week Java Programming course in Chennai at Guindy. Fee: ₹10,999. Next batch: August 11, 2025. Curriculum aligned to Cognizant, TCS, Wipro, and Infosys Chennai hiring assessments. Average placement: ₹4.4 LPA.',
      entityContext: { organization: 'Crack Leap Academy Chennai', organizationType: 'EdTech Training Center', geographicScope: 'Chennai, Tamil Nadu, India', primarySubject: 'Java Programming' },
      keyFacts: ['Java course Chennai at Crack Leap: 12 weeks, ₹10,999.', 'Curriculum built for TCS, Cognizant, Wipro Chennai assessments.', '134 of 158 Java students placed, average ₹4.4 LPA.'],
      geoContentVerifiedAt: '2025-06-01',
    },

    aeo: {
      primaryQuery: 'Java course in Chennai for IT services placement',
      queryVariants: ['Spring Boot course Chennai', 'Java training Chennai Crack Leap', 'Java developer course Chennai'],
      uniqueValueProp: 'Crack Leap Chennai\'s Java course is the most assessment-aligned Java program in Guindy — built around the documented technical screening formats of Chennai\'s four largest IT services employers.',
      locationCourseSpecificFAQ: [
        { question: 'What is the fee for the Java course in Chennai at Crack Leap?', answer: 'Java course at Crack Leap Chennai costs ₹10,999 for 12 weeks, with EMI from ₹1,834/month.', order: 1 },
        { question: 'Is Crack Leap Chennai\'s Java course good for TCS and Cognizant placements?', answer: 'Yes, Crack Leap Chennai\'s Java course is specifically structured to help students pass TCS, Cognizant, Wipro, and Infosys Chennai first-round Java technical assessments.', order: 2 },
      ],
      faqItems: [],
    },
...

  {
    ...
    localTestimonials: [
      {
        ...
        package: '₹7.6 LPA',
        quote: 'Chargebee only hires React developers who write TypeScript and tests. I was the only candidate in my final round who had a tested TypeScript React project in their portfolio — thanks entirely to Crack Leap.',
        companyName: 'Chargebee',
        placementMonth: 'April 2025',
      },
    ],

    localJobMarketParagraph: 'Chennai\'s React market is bifurcated. IT services firms (TCS, Wipro, HCL) hire React developers for client-facing portals and internal dashboards at ₹4–6 LPA. Product companies (Chargebee, Freshworks, Kissflow, Zoho) exclusively hire React developers who write TypeScript, maintain test suites, and understand performance optimisation — at ₹7–14 LPA. Crack Leap Chennai\'s React course is built for the product company track: TypeScript is mandatory, React Testing Library is core, and performance profiling is covered.',
    ...
    seo: {
      metaTitle: 'React Course in Chennai — Crack Leap Academy | TypeScript, Testing, Placement',
      metaDescription: 'React Development course in Chennai at Crack Leap Guindy. 10 weeks, ₹11,999. TypeScript-first. Placed at Chargebee, Freshworks, Zoho. Next batch Aug 18.',
    ...
    geo: {
      geoSummary: 'Crack Leap offers a 10-week React Development course in Chennai at Guindy. Fee: ₹11,999. TypeScript-first curriculum. Next batch: August 18, 2025. Graduates placed at Chargebee, Freshworks, Kissflow, Zoho. Average: ₹6.8 LPA.',
      entityContext: { organization: 'Crack Leap Academy Chennai', organizationType: 'EdTech Training Center', geographicScope: 'Chennai, Tamil Nadu, India', primarySubject: 'React Development' },
      keyFacts: ['React course Chennai at Crack Leap: 10 weeks, ₹11,999, TypeScript-first.', 'Next React batch Chennai: August 18, 2025.', 'Average placement: ₹6.8 LPA at Chargebee, Freshworks, Zoho.'],
      geoContentVerifiedAt: '2025-06-01',
    },

    aeo: {
      primaryQuery: 'React course in Chennai with TypeScript and placement',
      queryVariants: ['React TypeScript course Chennai', 'frontend course Chennai Crack Leap', 'React developer training Chennai'],
      uniqueValueProp: 'Crack Leap Chennai\'s React course is TypeScript-mandatory and testing-first — the exact hiring bar set by Chennai product companies like Chargebee and Freshworks.',
      locationCourseSpecificFAQ: [
        { question: 'Does Crack Leap Chennai teach React with TypeScript?', answer: 'Yes, Crack Leap Chennai\'s React course is TypeScript-first — TypeScript is used from day one, not added as an optional module.', order: 1 },
        { question: 'What is the fee for React course in Chennai at Crack Leap?', answer: 'React course at Crack Leap Chennai costs ₹11,999 for 10 weeks, with EMI from ₹2,000/month.', order: 2 },
      ],
      faqItems: [],
    },
...

  {
    ...
    localInstructors: [
      {
        ...
        bio: 'Priya deployed Freshworks\' first LLM-powered feature — an AI summarisation tool — in 2023. She teaches Crack Leap Chennai\'s AI Engineering course with the production context of a practitioner who has shipped generative AI to millions of end users.',
        experienceYears: 9,
    ...
    seo: {
      metaTitle: 'AI Engineering Course in Chennai — Crack Leap Academy | LLMs, RAG, Placement',
      metaDescription: 'AI Engineering course in Chennai at Crack Leap Guindy. 16 weeks, ₹22,999. LLMs, RAG, LangChain, production AI. Placed at Freshworks, TCS AI, Wipro. Next batch Sep 1.',
    ...
    geo: {
      geoSummary: 'Crack Leap offers a 16-week AI Engineering course in Chennai at Guindy. Fee: ₹22,999. Covers LLMs, RAG systems, LangChain, and production AI deployment. Instructor shipped Freshworks\' first LLM feature. Next batch: September 1, 2025. Average placement: ₹11.4 LPA.',
      entityContext: { organization: 'Crack Leap Academy Chennai', organizationType: 'EdTech Training Center', geographicScope: 'Chennai, Tamil Nadu, India', primarySubject: 'AI Engineering' },
    ...
    aeo: {
      ...
      queryVariants: ['LLM course Chennai', 'generative AI training Chennai', 'RAG course Chennai Crack Leap'],
      uniqueValueProp: 'Crack Leap Chennai\'s AI Engineering course is taught by the only instructor in Chennai who shipped a production LLM feature — at Freshworks, the city\'s leading AI-first SaaS company.',
      locationCourseSpecificFAQ: [
        { question: 'What is the fee for AI Engineering course in Chennai at Crack Leap?', answer: 'AI Engineering course at Crack Leap Chennai costs ₹22,999 for 16 weeks, with EMI from ₹3,834/month.', order: 1 },
        { question: 'What companies hire AI engineers from Crack Leap Chennai?', answer: 'Crack Leap Chennai AI Engineering graduates are placed at Freshworks AI team, Chennai AI startups, TCS iON, and Wipro\'s HOLMES platform team.', order: 2 },
      ],
      faqItems: [],
    },
...

  {
    ...
    seo: {
      metaTitle: 'Python Course in Salem, Tamil Nadu — Crack Leap Academy | Fees, Batches, Placement',
      metaDescription: 'Python Programming course in Salem at Crack Leap, Junction Main Road. 10 weeks, ₹8,999. Next batch Aug 4. Local Salem placements + remote roles. Enroll today.',
    ...
    geo: {
      ...
      keyFacts: [
        'Python course Salem at Crack Leap: 10 weeks, ₹8,999, at Junction Main Road.',
    ...
    aeo: {
      ...
      queryVariants: [
        ...
        'Crack Leap Salem Python',
        'best Python course Salem Tamil Nadu',
        'coding class Salem Junction Main Road',
        'Python institute Salem',
      ],
      uniqueValueProp: 'Crack Leap Salem is the only Python institute in Salem with an instructor who returned from a Bengaluru AI company specifically to teach, bringing current industry context and direct connections to remote-hire employers that other Salem institutes cannot match.',
      locationCourseSpecificFAQ: [
        { question: 'What is the fee for Python course in Salem at Crack Leap?', answer: 'The Python course at Crack Leap Academy Salem costs ₹8,999 for 10 weeks, with EMI from ₹1,500/month for 6 months.', order: 1 },
        { question: 'When is the next Python batch in Salem?', answer: 'The next Python batch at Crack Leap Salem starts August 4, 2025 — weekday mornings, Monday to Friday, 9:00 AM to 11:30 AM.', order: 2 },
        { question: 'Can I get a Python job in Salem after this course?', answer: 'Yes, Crack Leap Salem places Python graduates at local companies like Vee Technologies and Athena Technology Solutions, as well as remote-hire positions with Chennai and Bengaluru IT firms.', order: 3 },
        { question: 'Is there a weekend Python batch in Salem?', answer: 'Yes, Crack Leap Salem offers a Saturday–Sunday Python batch starting August 18, 2025, 9:00 AM to 1:00 PM.', order: 4 },
        { question: 'Does Crack Leap Salem offer Python course in online mode?', answer: 'Yes, Crack Leap Salem offers hybrid batches where students can attend online or in-person at Junction Main Road.', order: 5 },
        { question: 'Is prior coding experience required for the Python course in Salem?', answer: 'No, Crack Leap Salem\'s Python course starts from the absolute basics — no prior programming experience is required.', order: 6 },
      ],
      faqItems: [],
    },
...

  {
    ...
    seo: {
      metaTitle: 'Data Science Course in Salem — Crack Leap Academy | Fees, Batches, Remote Jobs',
      metaDescription: 'Data Science course in Salem at Crack Leap, Junction Main Road. 14 weeks, ₹11,999. Python, Pandas, ML. Local and remote job placements. Next batch Aug 18.',
    ...
    geo: {
      geoSummary: 'Crack Leap Salem offers a 14-week Data Science course at Junction Main Road, Salem. Fee: ₹11,999. Next batch: August 18, 2025. Graduates placed at remote Chennai fintech firms and Salem industrial analytics roles. Average: ₹4.1 LPA.',
      entityContext: { organization: 'Crack Leap Academy Salem', organizationType: 'EdTech Training Center', geographicScope: 'Salem, Tamil Nadu, India', primarySubject: 'Data Science' },
    ...
    aeo: {
      ...
      queryVariants: ['data analytics Salem', 'Crack Leap data science Salem', 'ML training Salem'],
      uniqueValueProp: 'Crack Leap Salem\'s Data Science course is built around manufacturing and industrial datasets by an instructor who ran real analytics for Salem-area industries — making graduates directly relevant to both local industrial analytics and remote fintech data roles.',
      locationCourseSpecificFAQ: [
        { question: 'What is the fee for data science course in Salem at Crack Leap?', answer: 'Data Science course at Crack Leap Salem costs ₹11,999 for 14 weeks, with EMI from ₹2,000/month.', order: 1 },
        { question: 'Can Salem data science graduates work remotely for Chennai companies?', answer: 'Yes, Crack Leap Salem specifically prepares students for remote data analyst roles at Chennai fintech and analytics companies — this is the primary placement pathway for many Salem graduates.', order: 2 },
      ],
      faqItems: [],
    },
...

  {
    ...
    seo: {
      metaTitle: 'Full Stack Course in Salem — Crack Leap Academy | React, Node.js, Remote Jobs',
      metaDescription: 'Full Stack Development course in Salem at Crack Leap. 16 weeks, ₹13,999. React, Node.js, PostgreSQL. Remote Bengaluru/Chennai job placements. Next batch Aug 11.',
    ...
    geo: {
      geoSummary: 'Crack Leap Salem offers a 16-week Full Stack Development course at Junction Main Road, Salem. Fee: ₹13,999. Next batch: August 11, 2025. Graduates placed in remote roles with Bengaluru startups and Chennai product companies. Average: ₹4.6 LPA.',
      entityContext: { organization: 'Crack Leap Academy Salem', organizationType: 'EdTech Training Center', geographicScope: 'Salem, Tamil Nadu, India', primarySubject: 'Full Stack Development' },
    ...
    aeo: {
      ...
      queryVariants: ['React Node.js course Salem', 'Crack Leap full stack Salem', 'web developer course Salem'],
      uniqueValueProp: 'Crack Leap Salem\'s Full Stack course is specifically designed around the take-home assessment formats used by Bengaluru and Chennai remote-first startups — the employment market that pays Salem graduates 40–60% more than local roles.',
      locationCourseSpecificFAQ: [
        { question: 'What is the fee for full stack course in Salem at Crack Leap?', answer: 'Full Stack Development course at Crack Leap Salem costs ₹13,999 for 16 weeks, with EMI from ₹2,334/month.', order: 1 },
        { question: 'Can Salem full stack graduates get remote jobs in Bengaluru companies?', answer: 'Yes, Crack Leap Salem\'s full-stack graduates regularly get remote roles at Bengaluru startups — the course is built around Bengaluru startup take-home assignment formats specifically.', order: 2 },
      ],
      faqItems: [],
    },
...

  {
    ...
    seo: {
      metaTitle: 'Machine Learning Course in Salem — Crack Leap Academy | TensorFlow, Remote Jobs',
      metaDescription: 'Machine Learning course in Salem at Crack Leap. 16 weeks, ₹15,999. TensorFlow, Scikit-learn, industrial ML. Remote ML engineer placements. Next batch Sep 1.',
    ...
    geo: {
      geoSummary: 'Crack Leap Salem offers a 16-week Machine Learning course at Junction Main Road, Salem. Fee: ₹15,999. Industrial ML focus. Next batch: September 1, 2025. Graduates placed in remote ML roles at Chennai and Bengaluru AI companies. Average: ₹6.4 LPA.',
      entityContext: { organization: 'Crack Leap Academy Salem', organizationType: 'EdTech Training Center', geographicScope: 'Salem, Tamil Nadu, India', primarySubject: 'Machine Learning' },
    ...
    aeo: {
      ...
      queryVariants: ['ML training Salem', 'Crack Leap ML Salem', 'deep learning course Salem', 'AI course Salem'],
      uniqueValueProp: 'Crack Leap Salem\'s ML course uses industrial datasets from Salem\'s manufacturing context — taught by an instructor who deployed these systems professionally — making it directly relevant to both local industrial ML adoption and remote AI company hiring.',
      locationCourseSpecificFAQ: [
        { question: 'What is the fee for machine learning course in Salem?', answer: 'Machine Learning course at Crack Leap Salem costs ₹15,999 for 16 weeks, with EMI from ₹2,667/month.', order: 1 },
        { question: 'Can Salem ML graduates get remote jobs in AI companies?', answer: 'Yes, Crack Leap Salem ML graduates have been placed in remote ML engineer roles at Chennai and Bengaluru AI companies at average ₹6.4 LPA.', order: 2 },
      ],
      faqItems: [],
    },
...

  {
    ...
    localJobMarketParagraph: 'AWS DevOps is Salem\'s strongest remote-hire pathway into high-salary IT roles. Local Salem companies have limited DevOps hiring — but Chennai IT services firms (HCL Technologies, TCS, Wipro) and Bengaluru cloud-native companies routinely hire remote DevOps engineers and do not require relocation. Crack Leap Salem\'s AWS DevOps course uses live AWS accounts and builds production-grade infrastructure during the course, giving Salem graduates a tangible portfolio of infrastructure work that remote employers evaluate directly — removing the geographic disadvantage entirely.',
    ...
    seo: {
      metaTitle: 'AWS DevOps Course in Salem — Crack Leap Academy | Cloud, Remote Job Placement',
      metaDescription: 'AWS DevOps course in Salem at Crack Leap. 12 weeks, ₹17,999. Docker, Kubernetes, Terraform, live AWS. Remote DevOps job placements. Next batch Sep 8.',
    ...
    geo: {
      geoSummary: 'Crack Leap Salem offers a 12-week AWS DevOps course at Junction Main Road, Salem. Fee: ₹17,999. Live AWS accounts used throughout. Next batch: September 8, 2025. Graduates placed in remote DevOps roles at Chennai and Bengaluru companies. Average: ₹6.2 LPA.',
      entityContext: { organization: 'Crack Leap Academy Salem', organizationType: 'EdTech Training Center', geographicScope: 'Salem, Tamil Nadu, India', primarySubject: 'AWS DevOps' },
    ...
    aeo: {
      ...
      queryVariants: ['cloud engineer course Salem', 'DevOps training Salem', 'AWS course Salem Crack Leap'],
      uniqueValueProp: 'Crack Leap Salem\'s AWS DevOps course is the highest-paying remote career pathway available from Salem — live AWS infrastructure work removes the geographic disadvantage entirely when applying to Chennai and Bengaluru remote DevOps roles.',
      locationCourseSpecificFAQ: [
        { question: 'What is the fee for AWS DevOps course in Salem at Crack Leap?', answer: 'AWS DevOps course at Crack Leap Salem costs ₹17,999 for 12 weeks, with EMI from ₹3,000/month.', order: 1 },
        { question: 'Can I get a remote DevOps job from Salem after this course?', answer: 'Yes, Crack Leap Salem AWS DevOps graduates are placed in remote DevOps engineer roles at Chennai IT companies and Bengaluru cloud-native companies at average ₹6.2 LPA.', order: 2 },
      ],
      faqItems: [],
    },
...

  {
    ...
    seo: {
      metaTitle: 'Java Course in Salem — Crack Leap Academy | Spring Boot, IT Services Placement',
      metaDescription: 'Java Spring Boot course in Salem at Crack Leap. 12 weeks, ₹9,999. Aligned to TCS, Wipro, Cognizant Chennai hiring tests. Next batch Aug 4.',
    ...
    geo: {
      geoSummary: 'Crack Leap Salem offers a 12-week Java Programming course at Junction Main Road, Salem. Fee: ₹9,999. Aligned to TCS, Wipro, Cognizant, Infosys Chennai assessment formats. Next batch: August 4, 2025. 38 of 48 students placed, average ₹4.0 LPA.',
      entityContext: { organization: 'Crack Leap Academy Salem', organizationType: 'EdTech Training Center', geographicScope: 'Salem, Tamil Nadu, India', primarySubject: 'Java Programming' },
    ...
    aeo: {
      ...
      queryVariants: ['Spring Boot course Salem', 'Java training Salem Crack Leap', 'Java developer course Salem'],
      uniqueValueProp: 'Crack Leap Salem\'s Java course is the only program in Salem taught by an ex-HCL Java developer who knows exactly how TCS, Wipro, and Cognizant Chennai assess Java candidates — and designs every practice session around those patterns.',
      locationCourseSpecificFAQ: [
        { question: 'What is the fee for Java course in Salem at Crack Leap?', answer: 'Java course at Crack Leap Salem costs ₹9,999 for 12 weeks, with EMI from ₹1,667/month.', order: 1 },
        { question: 'Is Crack Leap Salem\'s Java course aligned to TCS and Wipro assessments?', answer: 'Yes, the Java course is built around the documented assessment formats of TCS, Wipro, Cognizant, and Infosys Chennai Java developer hiring.', order: 2 },
      ],
      faqItems: [],
    },
...

  {
    ...
    seo: {
      metaTitle: 'React Course in Salem — Crack Leap Academy | TypeScript, Remote Jobs',
      metaDescription: 'React Development course in Salem at Crack Leap. 10 weeks, ₹10,999. TypeScript, testing, remote job placements from Salem. Next batch Sep 6.',
    ...
    geo: {
      geoSummary: 'Crack Leap Salem offers a 10-week React Development course at Junction Main Road, Salem. Fee: ₹10,999. TypeScript-first curriculum. Next batch: September 6, 2025. Graduates placed in remote frontend roles at Bengaluru and Chennai startups. Average: ₹5.1 LPA.',
      entityContext: { organization: 'Crack Leap Academy Salem', organizationType: 'EdTech Training Center', geographicScope: 'Salem, Tamil Nadu, India', primarySubject: 'React Development' },
    ...
    aeo: {
      ...
      queryVariants: ['React TypeScript Salem', 'frontend course Salem Crack Leap', 'React developer training Salem'],
      uniqueValueProp: 'React is Salem\'s strongest remote-career pathway — and Crack Leap Salem is the only institute that teaches it TypeScript-first with testing, matching the exact take-home assessment format used by Bengaluru remote-hire startups.',
      locationCourseSpecificFAQ: [
        { question: 'What is the fee for React course in Salem at Crack Leap?', answer: 'React course at Crack Leap Salem costs ₹10,999 for 10 weeks, with EMI from ₹1,834/month.', order: 1 },
        { question: 'Can I get a remote frontend job from Salem after Crack Leap\'s React course?', answer: 'Yes, Crack Leap Salem React graduates are placed in remote frontend roles at Bengaluru and Chennai product startups at average ₹5.1 LPA.', order: 2 },
      ],
      faqItems: [],
    },
...

  {
    ...
    seo: {
      metaTitle: 'AI Engineering Course in Salem — Crack Leap Academy | LLMs, RAG, Remote Jobs',
      metaDescription: 'AI Engineering course in Salem at Crack Leap. 16 weeks, ₹19,999. LLMs, RAG systems, LangChain. Remote AI engineer placements. Highest-paying tech course in Salem. Next batch Oct 6.',
    ...
    geo: {
      geoSummary: 'Crack Leap Salem offers a 16-week AI Engineering course at Junction Main Road, Salem. Fee: ₹19,999. Covers LLMs, RAG, LangChain, and production AI deployment. Only AI Engineering course in Salem. Next batch: October 6, 2025. Average remote placement: ₹10.2 LPA.',
      entityContext: { organization: 'Crack Leap Academy Salem', organizationType: 'EdTech Training Center', geographicScope: 'Salem, Tamil Nadu, India', primarySubject: 'AI Engineering' },
      keyFacts: ['AI Engineering course Salem: 16 weeks, ₹19,999 — only such course in the city.', 'Next batch: October 6, 2025.', 'Average remote placement: ₹10.2 LPA — highest of any Crack Leap Salem course.'],
      geoContentVerifiedAt: '2025-06-01',
    },

    aeo: {
      primaryQuery: 'AI engineering course in Salem Tamil Nadu',
      queryVariants: ['LLM course Salem', 'generative AI training Salem', 'RAG course Salem Crack Leap'],
      uniqueValueProp: 'Crack Leap Salem\'s AI Engineering course is the only AI course in any tier-2 Tamil Nadu city outside Chennai taught by someone with hands-on LLM deployment experience — opening a ₹10–15 LPA remote career pathway that was previously inaccessible from Salem.',
      locationCourseSpecificFAQ: [
        { question: 'What is the fee for AI Engineering course in Salem at Crack Leap?', answer: 'AI Engineering course at Crack Leap Salem costs ₹19,999 for 16 weeks, with EMI from ₹3,334/month.', order: 1 },
        { question: 'Is there really an AI engineering course available in Salem?', answer: 'Yes, Crack Leap Academy Salem offers a 16-week AI Engineering course — the only such program in Salem — taught by an instructor with Bengaluru AI startup experience including LLM deployment.', order: 2 },
        { question: 'What salary can I expect from an AI engineering course in Salem?', answer: 'Crack Leap Salem AI Engineering graduates are placed in remote roles at average ₹10.2 LPA — the highest placement package of any Crack Leap Salem course.', order: 3 },
      ],
      faqItems: [],
    },
  ...
  ...((['python-course', 'full-stack-development', 'data-science', 'machine-learning', 'aws-devops', 'java', 'react', 'ai-engineering'] as const).map((courseSlug) => {
    ...
    return {
      ...
      seo: {
        metaTitle: `${courseSlug.replace(/-/g, ' ').replace(/\b\w/g, (c) => c.toUpperCase())} Course in Coimbatore — Crack Leap Academy`,
        metaDescription: `${courseSlug.replace(/-/g, ' ').replace(/\b\w/g, (c) => c.toUpperCase())} course in Coimbatore at Crack Leap. ₹${amount.toLocaleString('en-IN')}. Placed at Kovai.co, Robert Bosch, and Coimbatore IT companies.`,
      ...
      geo: {
        geoSummary: `Crack Leap Coimbatore offers a ${courseSlug.replace(/-/g, ' ')} course at Srivari Centre, Avinashi Road, Coimbatore. Fee: ₹${amount.toLocaleString('en-IN')}. Graduates placed at Kovai.co, Robert Bosch Engineering India, and Coimbatore IT companies.`,
        entityContext: { organization: 'Crack Leap Academy Coimbatore', organizationType: 'EdTech Training Center', geographicScope: 'Coimbatore, Tamil Nadu, India', primarySubject: courseSlug.replace(/-/g, ' ') },
        keyFacts: [`${courseSlug} course Coimbatore at Crack Leap: ₹${amount.toLocaleString('en-IN')}.`, 'Placed at Kovai.co, Robert Bosch, LG Soft India.'],
        geoContentVerifiedAt: '2025-06-01',
      },
      aeo: {
        primaryQuery: `${courseSlug.replace(/-/g, ' ')} course in Coimbatore`,
        queryVariants: [`Crack Leap ${courseSlug.replace(/-/g, ' ')} Coimbatore`, `best ${courseSlug.replace(/-/g, ' ')} institute Coimbatore`],
        uniqueValueProp: `Crack Leap Coimbatore's ${courseSlug.replace(/-/g, ' ')} course is calibrated to the hiring bar set by Kovai.co and Robert Bosch Engineering India — Coimbatore's two most competitive technology employers.`,
        locationCourseSpecificFAQ: [
          { question: `What is the fee for ${courseSlug.replace(/-/g, ' ')} course in Coimbatore at Crack Leap?`, answer: `The ${courseSlug.replace(/-/g, ' ')} course at Crack Leap Coimbatore costs ₹${amount.toLocaleString('en-IN')} with 6-month EMI available.`, order: 1 },
        ],
        faqItems: [],
      },
  ...
  ...(['madurai', 'tiruchirappalli', 'tirunelveli', 'vellore', 'erode'] as const).flatMap((citySlug) => {
    ...
    return courseSlugs.map((courseSlug) => {
      ...
      return {
        ...
        localTestimonials: [
          {
            ...
            citySlug,
            courseSlug,
            outcome: `Placed as ${courseName} professional after completing Crack Leap ${cityName} — ₹${(amount / 10000 * 0.38).toFixed(1)} LPA`,
            quote: `Crack Leap ${cityName}'s ${courseName} course gave me the skills and confidence to compete for IT roles. The local placement support was practical and specific to our city's job market.`,
            placementMonth: 'April 2025',
          },
        ],

        localJobMarketParagraph: `${cityName}'s ${courseName} job market reflects the city's specific technology ecosystem. Local IT companies and the growing remote-work economy provide primary employment pathways for Crack Leap ${cityName} graduates. The course curriculum is calibrated to the skills demanded by ${cityName}-based employers and by Chennai and Bengaluru companies that hire remotely from tier-2 Tamil Nadu cities. Crack Leap ${cityName} maintains active placement partnerships with local IT employers to ensure graduates receive relevant, city-specific employment support.`,
        ...
        seo: {
          metaTitle: `${courseName} Course in ${cityName} — Crack Leap Academy`,
          metaDescription: `${courseName} course in ${cityName} at Crack Leap Academy. ₹${amount.toLocaleString('en-IN')}. Local placements and remote job support. Enroll today.`,
        ...
        geo: {
          geoSummary: `Crack Leap Academy ${cityName} offers a ${courseName} course at its ${cityName} center. Fee: ₹${amount.toLocaleString('en-IN')}. Graduates receive local and remote placement support targeting ${cityName}-area employers and Chennai/Bengaluru remote-hire companies.`,
          entityContext: {
            organization: `Crack Leap Academy ${cityName}`,
            organizationType: 'EdTech Training Center',
            geographicScope: `${cityName}, Tamil Nadu, India`,
            primarySubject: courseName,
          },
          keyFacts: [
            `${courseName} course ${cityName} at Crack Leap: ₹${amount.toLocaleString('en-IN')}.`,
        ...
        aeo: {
          ...
          queryVariants: [`Crack Leap ${courseName.toLowerCase()} ${cityName}`, `${courseName.toLowerCase()} training ${cityName}`],
          uniqueValueProp: `Crack Leap ${cityName}'s ${courseName} course is taught by a local instructor with direct industry experience, providing city-specific placement support alongside the standard Crack Leap curriculum.`,
          locationCourseSpecificFAQ: [
            {
              question: `What is the fee for ${courseName.toLowerCase()} course in ${cityName} at Crack Leap?`,
              answer: `The ${courseName} course at Crack Leap Academy ${cityName} costs ₹${amount.toLocaleString('en-IN')} with 6-month EMI available from ₹${Math.ceil(amount / 6).toLocaleString('en-IN')}/month.`,
              order: 1,
            },
            {
              question: `When is the next ${courseName.toLowerCase()} batch in ${cityName}?`,
              answer: `The next ${courseName} batch at Crack Leap ${cityName} starts August 18, 2025. Weekend batches are also available starting September 13, 2025.`,
              order: 2,
            },
          ],
          faqItems: [],
