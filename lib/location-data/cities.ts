...
const instructors: Record<string, Instructor> = {
  priya_chennai: {
    ...
    bio: 'Priya has 9 years of experience in data engineering and machine learning at Zoho Corporation and Freshworks. She has trained over 400 students at ArivuOn Chennai and specialises in bridging the gap between academic Python and industry-grade data pipelines.',
    experienceYears: 9,
  ...
  karthik_chennai: {
    ...
    bio: 'Karthik is a full-stack architect with 11 years of industry experience at ThoughtWorks and Hexaware Technologies. He leads ArivuOn Chennai\'s full-stack and DevOps programs, with a focus on real-world project-based learning.',
    experienceYears: 11,
  ...
  meena_coimbatore: {
    ...
    bio: 'Meena has 7 years of applied data science experience in Coimbatore\'s textile and manufacturing analytics sector, having implemented ML-based demand forecasting systems for major Coimbatore exporters before joining ArivuOn.',
    experienceYears: 7,
  ...
  senthil_madurai: {
    ...
    bio: 'Senthil has 7 years of experience in enterprise software development, working with companies based in Madurai and remotely for Chennai IT firms. He is a certified Java developer and Python specialist who has mentored over 200 ArivuOn Madurai graduates.',
    experienceYears: 7,
  ...
  divya_madurai: {
    ...
    citySlug: 'madurai',
    courseSlugs: ['full-stack-development', 'react', 'aws-devops'],
    bio: 'Divya is a full-stack developer with 6 years of experience, having built web applications for e-commerce and healthcare startups. She joined ArivuOn Madurai to teach modern full-stack development with React and Node.js.',
    experienceYears: 6,
  ...
  kavitha_salem: {
    ...
    bio: 'Kavitha is a full-stack engineer with 7 years of experience in Java and React development. She previously worked for Chennai IT services companies and returned to Salem to lead ArivuOn\'s full-stack and Java programs for local students.',
    experienceYears: 7,
  ...
  ramesh_trichy: {
    ...
    bio: 'Ramesh has 9 years of software development and data analytics experience, with a background in BHEL Trichy\'s IT systems before transitioning to software development training. He brings a strong engineering-to-IT crossover perspective to ArivuOn Trichy.',
    experienceYears: 9,
  ...
  arjun_vellore: {
    ...
    bio: 'Arjun has 7 years of experience in ML and data science, with a research background from VIT University (Vellore). He worked at a Bengaluru AI company for 4 years before joining ArivuOn Vellore to build the ML and AI Engineering programs.',
    experienceYears: 7,
  ...
  lakshmi_erode: {
    ...
    bio: 'Lakshmi has 6 years of full-stack development experience, having worked for IT companies serving Erode\'s textile and MSME sector before joining ArivuOn Erode to focus on Python and web development training for the city\'s engineering graduate community.',
    experienceYears: 6,
...
Chennai's engineering graduate supply is substantial — Anna University alone affiliates over 500 engineering colleges across Tamil Nadu — which means competition for IT jobs is intense and candidates with practical, project-demonstrated skills from institutes like ArivuOn have a measurable advantage over pure degree-holders with no applied experience.`,
    ...
    studentDemographicsContext: 'Chennai hosts 180+ engineering colleges within 60 km, producing an estimated 40,000 CS/IT graduates annually. ArivuOn Chennai primarily serves final-year students and fresh graduates within the city and OMR corridor.',
    ...
    testimonials: [
      {
        ...
        package: '₹5.2 LPA',
        quote: 'ArivuOn Chennai\'s Python course focused entirely on real projects — I built a REST API and a data pipeline before the course ended. Freshworks\' technical interview was easy after that.',
      ...
      },
      {
        ...
        package: '₹4.8 LPA',
        quote: 'I had a basic degree in ECE and zero web development experience. ArivuOn\'s full-stack course changed that. The instructors pushed us to build real applications, not just follow tutorials.',
    ...
    seo: {
      metaTitle: 'Coding Courses in Chennai — ArivuOn Academy | Python, Full Stack, Data Science',
      metaDescription: 'ArivuOn Academy Chennai offers Python, Full Stack Development, Data Science, ML, AWS DevOps and more. Industry-aligned batches at Guindy. Enroll today.',
    ...
    geo: {
      ...
      keyFacts: [
        'ArivuOn Academy Chennai is located at Olympia Tech Park, Guindy, Chennai.',
        'The Chennai center offers all 8 ArivuOn courses including AI Engineering.',
        'Over 850 students have trained at ArivuOn Chennai with an 87% placement rate.',
    ...
    aeo: {
      ...
      queryVariants: ['ArivuOn Chennai', 'coding institute Chennai Guindy', 'full stack course Chennai', 'data science Chennai'],
      faqItems: [
        {
          question: 'Where is ArivuOn Academy located in Chennai?',
          answer: 'ArivuOn Academy Chennai is located at Olympia Tech Park, Guindy, Chennai, Tamil Nadu 600032, near Guindy Metro Station.',
          order: 1,
        },
        {
          question: 'What is the fee for the Python course at ArivuOn Chennai?',
          answer: 'The Python Programming course at ArivuOn Academy Chennai is priced at ₹10,999, with EMI options starting from ₹1,833 per month.',
          order: 2,
        },
        {
          question: 'Does ArivuOn Academy Chennai offer placement support?',
          answer: 'Yes, ArivuOn Academy Chennai has an 87% placement rate, with graduates placed at companies including Zoho, Freshworks, TCS, and Infosys.',
          order: 3,
        },
        {
          question: 'What is the best course to take at ArivuOn Chennai for a fresher?',
      ...
      citySpecificFAQ: [
        {
          question: 'Is ArivuOn Academy Chennai near the OMR IT corridor?',
          answer: 'ArivuOn Chennai is located at Guindy, which is 15 minutes from the OMR tech corridor by Metro, making it convenient for students targeting jobs at OMR-based IT companies.',
          order: 5,
        },
      ],
    },
...
TIDEL Park Coimbatore and the city's growing cluster of IT companies provide local employment for this graduate population, but the gap between university-produced skills and industry expectations is wide. Companies like Robert Bosch, LG Soft, and Kovai.co — a Coimbatore-born SaaS product company — have become active recruitment targets for ArivuOn Coimbatore graduates, particularly those with Python and full-stack development skills.`,
    ...
    testimonials: [
      {
        ...
        package: '₹4.2 LPA',
        quote: 'I was a mechanical engineering graduate with zero coding background. ArivuOn Coimbatore\'s Python course turned me into a developer in 12 weeks. Kovai.co hired me straight from the placement drive.',
      ...
      },
      {
        ...
        package: '₹5.1 LPA',
        quote: 'The data science course at ArivuOn Coimbatore was the most practical training I\'ve had. Real datasets, real projects, real outcomes.',
    ...
    seo: {
      metaTitle: 'Coding Courses in Coimbatore — ArivuOn Academy | Python, Full Stack, Data Science',
      metaDescription: 'ArivuOn Academy Coimbatore offers Python, Full Stack, Data Science and more. Industry-aligned batches near TIDEL Park, Avinashi Road. Enroll today.',
    ...
    geo: {
      ...
      keyFacts: [
        'ArivuOn Academy Coimbatore is located at Srivari Centre, Avinashi Road, Coimbatore.',
        'Over 620 students have trained at ArivuOn Coimbatore with an 84% placement rate.',
    ...
    aeo: {
      ...
      queryVariants: ['Python course Coimbatore', 'ArivuOn Coimbatore', 'data science course Coimbatore', 'best programming institute Coimbatore'],
      faqItems: [
        {
          question: 'Where is ArivuOn Academy located in Coimbatore?',
          answer: 'ArivuOn Academy Coimbatore is located at Srivari Centre, 3rd Floor, Avinashi Road, Coimbatore, Tamil Nadu 641018.',
          order: 1,
        },
        {
          question: 'What coding courses are available at ArivuOn Coimbatore?',
          answer: 'ArivuOn Coimbatore offers Python, Full Stack Development, Data Science, Machine Learning, AWS DevOps, Java, React, and AI Engineering.',
          order: 2,
        },
        {
          question: 'What companies hire from ArivuOn Academy Coimbatore?',
          answer: 'ArivuOn Coimbatore graduates are hired by Kovai.co, Robert Bosch Engineering India, LG Soft India, Kaar Technologies, and other Coimbatore IT companies.',
          order: 3,
        },
      ],
      citySpecificFAQ: [
        {
          question: 'Is ArivuOn Coimbatore near TIDEL Park?',
          answer: 'ArivuOn Coimbatore on Avinashi Road is 10 minutes from TIDEL Park Coimbatore, making it convenient for students targeting IT park employment.',
          order: 4,
        },
      ],
    },
...
ArivuOn Madurai's presence directly addresses this migration pressure: graduates who complete ArivuOn's courses are equipped to compete for positions at Madurai IT Park companies and with Chennai firms that accept remote and hybrid employees, allowing them to build careers locally.`,
    ...
    testimonials: [
      {
        ...
        package: '₹3.8 LPA',
        quote: 'I was unemployed for 8 months after my degree. ArivuOn Madurai\'s Python course got me job-ready in 10 weeks and placed locally so I didn\'t have to move to Chennai.',
    ...
    seo: {
      metaTitle: 'Coding Courses in Madurai — ArivuOn Academy | Python, Java, Full Stack',
      metaDescription: 'ArivuOn Academy Madurai offers Python, Java, Full Stack Development, Data Science and more at Anna Nagar, Madurai. Local placements at Madurai IT companies.',
    ...
    geo: {
      ...
      keyFacts: [
        'ArivuOn Academy Madurai is at Kumaran Towers, Anna Nagar, Madurai, Tamil Nadu.',
        'Over 410 students trained at ArivuOn Madurai with an 81% placement rate.',
    ...
    aeo: {
      ...
      queryVariants: ['Python course Madurai', 'ArivuOn Madurai', 'software training Madurai', 'IT course Madurai'],
      faqItems: [
        {
          question: 'Where is ArivuOn Academy in Madurai?',
          answer: 'ArivuOn Academy Madurai is at Kumaran Towers, 1st Floor, Anna Nagar, Madurai, Tamil Nadu 625020.',
          order: 1,
        },
        {
          question: 'Can I get a job in Madurai after completing ArivuOn courses?',
          answer: 'Yes, ArivuOn Madurai has an 81% placement rate and works with local IT park companies including iLink Digital, Infosys BPO, and Wipro Madurai.',
          order: 2,
        },
      ],
      citySpecificFAQ: [],
...
Salem's emerging IT ecosystem, centred around a growing number of IT service companies and analytics firms, combined with a low cost of living relative to metro cities, is making it increasingly viable for students to build software careers locally. ArivuOn Salem's courses are specifically calibrated to the skills demanded by Salem-area companies and to prepare students for remote roles with Chennai and Bengaluru firms — a pathway that has become increasingly accessible since 2020.`,
    ...
    testimonials: [
      {
        ...
        package: '₹3.6 LPA',
        quote: 'I completed my degree in 2023 and couldn\'t find a job for a year. ArivuOn Salem gave me Python skills that were actually marketable. Vee Technologies hired me 3 weeks after I finished the course.',
      ...
      },
      {
        ...
        package: '₹4.4 LPA',
        quote: 'ArivuOn Salem\'s data science program showed me I could work for Chennai companies while living in Salem. The remote-ready skills they taught made the difference.',
    ...
    seo: {
      metaTitle: 'Coding Courses in Salem, Tamil Nadu — ArivuOn Academy | Python, Data Science, Full Stack',
      metaDescription: 'ArivuOn Academy Salem offers Python, Data Science, Full Stack Development, ML and more at Junction Main Road, Salem. Local placements + remote work pathways. Enroll today.',
    ...
    geo: {
      ...
      keyFacts: [
        'ArivuOn Academy Salem is at Shenbagam Towers, Junction Main Road, Salem, Tamil Nadu 636004.',
        'Over 310 students have been trained at ArivuOn Salem with an 80% placement rate.',
    ...
    aeo: {
      ...
      faqItems: [
        {
          question: 'Where is ArivuOn Academy Salem located?',
          answer: 'ArivuOn Academy Salem is at Shenbagam Towers, 2nd Floor, Junction Main Road, Salem, Tamil Nadu 636004 — 1.5 km from Salem Junction Railway Station.',
          order: 1,
        },
        {
          question: 'What is the fee for the Python course in Salem at ArivuOn?',
          answer: 'The Python Programming course at ArivuOn Academy Salem is priced at ₹8,999, with 6-month EMI options available.',
          order: 2,
        },
        {
          question: 'What is the next batch date at ArivuOn Salem?',
          answer: 'ArivuOn Salem runs batches every 6–8 weeks. Contact the Salem center at +91-427-4567-890 or WhatsApp +91-98765-43213 for current batch dates.',
          order: 3,
        },
        {
          question: 'Can I get a job in Salem after completing ArivuOn courses?',
          answer: 'Yes, ArivuOn Salem has an 80% placement rate with local placements at Vee Technologies, Athena Technology Solutions, and other Salem IT companies, plus remote-hire opportunities with Chennai and Bengaluru firms.',
          order: 4,
        },
        {
          question: 'Does ArivuOn Salem offer online courses?',
          answer: 'Yes, ArivuOn Academy Salem offers online, in-person, and hybrid batch options across all courses.',
          order: 5,
        },
      ],
      citySpecificFAQ: [
        {
          question: 'Is ArivuOn Salem suitable for first-generation engineering graduates?',
          answer: 'Yes, ArivuOn Salem\'s courses are designed for students from all backgrounds. The beginner-level Python and Full Stack courses start from scratch with no prior coding knowledge required.',
          order: 6,
        },
      ],
    },
...
NIT Trichy's reputation ensures a constant supply of high-calibre engineering graduates in and around the city, many of whom seek additional practical skills to supplement their academic preparation for competitive software roles.`,
    ...
    testimonials: [
      {
        ...
        package: '₹4.5 LPA',
        quote: 'ArivuOn Trichy\'s full-stack course gave me the React and Node.js skills that CSS Corp was specifically looking for. The course is much more current than what university teaches.',
    ...
    seo: {
      metaTitle: 'Coding Courses in Tiruchirappalli (Trichy) — ArivuOn Academy',
      metaDescription: 'ArivuOn Academy Trichy offers Python, Full Stack, Data Science, Java and more at Singarathope, Trichy. Placements at local IT companies. Enroll today.',
    ...
    geo: {
      geoSummary: 'ArivuOn Academy Tiruchirappalli (Trichy) is at Kaveri Complex, Singarathope, Tiruchirappalli, Tamil Nadu 620002. The center offers all 8 ArivuOn courses. Course fees range from ₹8,999 to ₹19,999. Students are placed at ELCOT IT Park companies, CSS Corp, Infosys Trichy, and other local IT employers.',
      entityContext: {
        organization: 'ArivuOn Academy Tiruchirappalli',
        organizationType: 'EdTech Training Center',
      ...
      keyFacts: [
        'ArivuOn Academy Trichy is at Kaveri Complex, Singarathope, Tiruchirappalli 620002.',
        'Over 280 students trained at ArivuOn Trichy with 82% placement rate.',
    ...
    aeo: {
      ...
      queryVariants: ['Python course Trichy', 'ArivuOn Trichy', 'software training Tiruchirappalli', 'full stack course Trichy'],
      faqItems: [
        {
          question: 'Where is ArivuOn Academy in Trichy?',
          answer: 'ArivuOn Academy Trichy is at Kaveri Complex, 4th Floor, Singarathope, Tiruchirappalli, Tamil Nadu 620002, near Trichy Junction Railway Station.',
          order: 1,
        },
        {
          question: 'What is the fee for courses at ArivuOn Trichy?',
          answer: 'Course fees at ArivuOn Academy Trichy range from ₹8,999 to ₹19,999 depending on the program.',
          order: 2,
        },
      ],
      citySpecificFAQ: [],
...
ArivuOn Tirunelveli's establishment addresses a genuine underserved demand: quality technical training that can transform graduates from the southern tip of Tamil Nadu into software developers without requiring relocation to a metro city.`,
    ...
    testimonials: [
      {
        ...
        package: '₹3.4 LPA',
        quote: 'ArivuOn Tirunelveli made it possible for me to work for a Chennai company without leaving home. The remote-work training and portfolio guidance were essential.',
        companyName: 'Chennai IT firm (remote)',
        placementMonth: 'April 2025',
      },
    ],
    ...
    seo: {
      metaTitle: 'Coding Courses in Tirunelveli — ArivuOn Academy | Python, Java, Full Stack',
      metaDescription: 'ArivuOn Academy Tirunelveli offers Python, Java, Full Stack Development, Data Science at Palayamkottai Road. Local + remote job placements. Enroll today.',
    ...
    geo: {
      geoSummary: 'ArivuOn Academy Tirunelveli is at KK Towers, Palayamkottai Road, Tirunelveli, Tamil Nadu 627002. Courses include Python, Full Stack Development, Data Science, and more with fees from ₹8,999 to ₹19,999. Students are placed locally and in remote roles with Chennai IT companies.',
      entityContext: {
        organization: 'ArivuOn Academy Tirunelveli',
        organizationType: 'EdTech Training Center',
      ...
      keyFacts: [
        'ArivuOn Academy Tirunelveli is at KK Towers, Palayamkottai Road, Tirunelveli 627002.',
        '190 students trained at ArivuOn Tirunelveli with 77% placement rate.',
    ...
    aeo: {
      ...
      queryVariants: ['Python course Tirunelveli', 'ArivuOn Tirunelveli', 'software training Tirunelveli'],
      faqItems: [
        {
          question: 'Where is ArivuOn Academy in Tirunelveli?',
          answer: 'ArivuOn Academy Tirunelveli is at KK Towers, 3rd Floor, Palayamkottai Road, Tirunelveli, Tamil Nadu 627002.',
          order: 1,
        },
      ],
      citySpecificFAQ: [],
...
The city's proximity to Chennai (approximately 140 km) means Vellore students have both local employment options at companies drawn to the educated graduate pool and easy access to Chennai's large job market.`,
    ...
    testimonials: [
      {
        ...
        package: '₹6.2 LPA',
        quote: 'I was a VIT graduate with good theoretical knowledge but no practical ML projects. ArivuOn Vellore\'s ML course gave me 3 real projects that got me an ML engineer role in Chennai.',
    ...
    seo: {
      metaTitle: 'Coding Courses in Vellore — ArivuOn Academy | Python, ML, Data Science',
      metaDescription: 'ArivuOn Academy Vellore offers Python, Machine Learning, Data Science, Full Stack near VIT University. Industry-grade courses for Vellore\'s top engineering talent.',
    ...
    geo: {
      ...
      keyFacts: [
        'ArivuOn Academy Vellore is at Katpadi Road, Vellore — near VIT University.',
        '220 students trained at ArivuOn Vellore with 85% placement rate.',
    ...
    aeo: {
      ...
      queryVariants: ['Python course Vellore', 'ML course Vellore', 'ArivuOn Vellore', 'data science Vellore'],
      faqItems: [
        {
          question: 'Where is ArivuOn Academy in Vellore?',
          answer: 'ArivuOn Academy Vellore is at Vasanth Nagar Complex, 2nd Floor, Katpadi Road, Vellore, Tamil Nadu 632001, near VIT University.',
          order: 1,
        },
        {
          question: 'Is ArivuOn Vellore suitable for VIT University students?',
          answer: 'Yes, ArivuOn Vellore\'s Machine Learning and AI Engineering courses are especially valuable for VIT students who want to turn academic knowledge into industry-ready projects and placements.',
          order: 2,
        },
      ],
      citySpecificFAQ: [],
...
ArivuOn Erode serves the gap between theoretical education and employment-ready skills, with courses calibrated to both local digitisation needs (data, Python-based automation) and preparation for roles in Coimbatore, Salem, and Chennai.`,
    ...
    testimonials: [
      {
        ...
        package: '₹3.5 LPA',
        quote: 'I didn\'t want to move to Chennai. ArivuOn Erode trained me to work for a Coimbatore company — I commute just 70 km. The full-stack course was exactly what local companies needed.',
    ...
    seo: {
      metaTitle: 'Coding Courses in Erode, Tamil Nadu — ArivuOn Academy | Python, Full Stack',
      metaDescription: 'ArivuOn Academy Erode offers Python, Full Stack Development, Data Science and more at Perundurai Road, Erode. Local and Coimbatore placements available.',
    ...
    geo: {
      ...
      keyFacts: [
        'ArivuOn Academy Erode is at Kavitha Complex, Perundurai Road, Erode 638011.',
        '165 students trained at ArivuOn Erode with 78% placement rate.',
    ...
    aeo: {
      ...
      queryVariants: ['Python course Erode', 'ArivuOn Erode', 'software training Erode', 'IT course Erode'],
      faqItems: [
        {
          question: 'Where is ArivuOn Academy in Erode?',
          answer: 'ArivuOn Academy Erode is at Kavitha Complex, 1st Floor, Perundurai Road, Erode, Tamil Nadu 638011.',
          order: 1,
        },
        {
          question: 'Can Erode students get jobs at Coimbatore companies through ArivuOn?',
          answer: 'Yes, ArivuOn Erode places graduates at Coimbatore IT companies which are within commuting distance, as well as local Erode employers and remote-hire Chennai firms.',
          order: 2,
        },
      ],
      citySpecificFAQ: [],
