...
export const courses: Course[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    toolsUsed: ['Python 3.11+', 'Flask', 'FastAPI', 'Pandas', 'NumPy', 'pytest', 'Git', 'VS Code', 'Postman'],
    certificationOffered: true,
    certificationName: 'ArivuOn Python Developer Certificate',
    certificationProvider: 'ArivuOn Academy',
    syllabus: [
      { order: 1, title: 'Python Foundations', topics: ['Syntax, data types, variables', 'Control flow: if/else, loops', 'Functions and scope', 'Modules and packages'], durationHours: 20 },
      { order: 2, title: 'Data Structures & OOP', topics: ['Lists, tuples, dicts, sets', 'Classes and objects', 'Inheritance and polymorphism', 'File I/O and JSON handling'], durationHours: 25 },
      { order: 3, title: 'Python Libraries', topics: ['NumPy arrays and operations', 'Pandas DataFrames', 'Data cleaning and manipulation', 'Matplotlib basics'], durationHours: 25 },
      { order: 4, title: 'Web APIs with Flask/FastAPI', topics: ['HTTP fundamentals', 'Building REST endpoints', 'Request/response handling', 'Authentication basics', 'Database integration with SQLite'], durationHours: 30 },
      { order: 5, title: 'Testing & Version Control', topics: ['pytest fundamentals', 'Writing testable code', 'Git workflow for teams', 'GitHub and pull requests'], durationHours: 12 },
      { order: 6, title: 'Capstone Project', topics: ['Full Python application build', 'REST API + data processing', 'Deployment to cloud', 'Portfolio presentation'], durationHours: 8 },
    ],
    ...
    description: 'ArivuOn\'s Python Programming course is a 10-week, project-first program that takes students from zero programming knowledge to a deployable Python application. The curriculum is built around real-world tasks — data processing, API development, automation — rather than theoretical exercises. Students graduate with three portfolio projects and the Python skills that entry-level developer roles demand.',
    ...
    relatedCourseSlugs: ['data-science', 'machine-learning', 'full-stack-development'],
    canonicalCourseUrl: 'https://arivuon.com/courses/python',
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    prerequisites: ['Basic computer literacy', 'No prior web development experience required'],
    learningOutcomes: [
    ...
    toolsUsed: ['HTML5', 'CSS3', 'JavaScript ES6+', 'React 18', 'Node.js', 'Express', 'PostgreSQL', 'MongoDB', 'Git', 'Vercel', 'Railway'],
    certificationOffered: true,
    certificationName: 'ArivuOn Full Stack Developer Certificate',
    certificationProvider: 'ArivuOn Academy',
    syllabus: [
      { order: 1, title: 'HTML, CSS & Responsive Design', topics: ['Semantic HTML5', 'CSS Flexbox and Grid', 'Responsive design and media queries', 'Accessibility basics'], durationHours: 30 },
      { order: 2, title: 'JavaScript Fundamentals', topics: ['ES6+ syntax', 'DOM manipulation', 'Async JavaScript: callbacks, promises, async/await', 'Fetch API and REST consumption'], durationHours: 40 },
      { order: 3, title: 'React', topics: ['Components and props', 'State and hooks', 'React Router', 'Context API', 'API integration', 'React Query'], durationHours: 50 },
      { order: 4, title: 'Node.js & Express Backend', topics: ['Node.js runtime', 'Express REST API', 'Middleware and routing', 'Authentication with JWT', 'File uploads'], durationHours: 40 },
      { order: 5, title: 'Databases', topics: ['PostgreSQL design and queries', 'Prisma ORM', 'MongoDB basics', 'Database security'], durationHours: 20 },
      { order: 6, title: 'Deployment & Capstone', topics: ['Cloud deployment (Vercel, Railway)', 'CI/CD basics', 'Full-stack capstone project', 'Portfolio review'], durationHours: 20 },
    ],
    ...
    schema: {
      schemaType: 'Course',
      educationalLevel: 'Beginner',
      teaches: ['React', 'Node.js', 'PostgreSQL', 'JavaScript', 'Full Stack Development'],
      about: 'Full Stack Web Development',
    },
    relatedCourseSlugs: ['react', 'aws-devops', 'python-course'],
    canonicalCourseUrl: 'https://arivuon.com/courses/full-stack-development',
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    prerequisites: ['Basic Python knowledge (or completion of ArivuOn Python course)', 'Basic mathematics/statistics understanding'],
    learningOutcomes: [
    ...
    toolsUsed: ['Python', 'Pandas', 'NumPy', 'Scikit-learn', 'Matplotlib', 'Seaborn', 'SQL', 'Jupyter Notebook', 'Streamlit', 'Power BI'],
    certificationOffered: true,
    certificationName: 'ArivuOn Data Science Certificate',
    certificationProvider: 'ArivuOn Academy',
    syllabus: [
      { order: 1, title: 'Data Analysis with Python', topics: ['Pandas for data manipulation', 'NumPy arrays and operations', 'Data cleaning and transformation', 'EDA workflows'], durationHours: 30 },
      { order: 2, title: 'Statistics for Data Science', topics: ['Descriptive statistics', 'Probability distributions', 'Hypothesis testing', 'Correlation and regression'], durationHours: 25 },
      { order: 3, title: 'Machine Learning Fundamentals', topics: ['Supervised vs unsupervised learning', 'Linear and logistic regression', 'Decision trees and random forests', 'Model evaluation metrics'], durationHours: 40 },
      { order: 4, title: 'Data Visualisation & Dashboards', topics: ['Matplotlib and Seaborn', 'Storytelling with data', 'Streamlit dashboard building', 'Power BI basics'], durationHours: 25 },
      { order: 5, title: 'SQL & Data Engineering Basics', topics: ['SQL queries and joins', 'Database design for analytics', 'Data pipelines introduction', 'ETL concepts'], durationHours: 20 },
      { order: 6, title: 'Capstone Project', topics: ['End-to-end data science project', 'Model deployment', 'Portfolio presentation', 'GitHub documentation'], durationHours: 20 },
    ],
    ...
    schema: {
      ...
      teaches: ['Data Science', 'Machine Learning', 'Python', 'Statistics', 'SQL'],
      about: 'Data Science and Machine Learning',
    },
    relatedCourseSlugs: ['machine-learning', 'python-course', 'ai-engineering'],
    canonicalCourseUrl: 'https://arivuon.com/courses/data-science',
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    prerequisites: ['Python proficiency', 'Basic statistics', 'Familiarity with NumPy and Pandas'],
    learningOutcomes: [
    ...
    toolsUsed: ['Python', 'Scikit-learn', 'TensorFlow', 'Keras', 'PyTorch', 'OpenCV', 'HuggingFace', 'MLflow', 'FastAPI', 'Docker'],
    certificationOffered: true,
    certificationName: 'ArivuOn Machine Learning Engineer Certificate',
    certificationProvider: 'ArivuOn Academy',
    syllabus: [
      { order: 1, title: 'ML Foundations & Algorithms', topics: ['Regression, classification, clustering', 'Feature engineering and selection', 'Cross-validation and hyperparameter tuning', 'Ensemble methods'], durationHours: 40 },
      { order: 2, title: 'Deep Learning with TensorFlow', topics: ['Neural network architecture', 'Backpropagation', 'CNNs and image classification', 'Transfer learning'], durationHours: 50 },
      { order: 3, title: 'NLP Fundamentals', topics: ['Text preprocessing', 'TF-IDF and word embeddings', 'Sequence models (LSTM)', 'Transformer basics and HuggingFace'], durationHours: 30 },
      { order: 4, title: 'MLOps & Experiment Tracking', topics: ['MLflow experiments', 'Model versioning', 'Docker containers for ML', 'REST API deployment'], durationHours: 30 },
      { order: 5, title: 'Capstone ML Project', topics: ['Problem definition and dataset curation', 'End-to-end model pipeline', 'Model deployment', 'Portfolio presentation'], durationHours: 30 },
    ],
    ...
    description: 'ArivuOn\'s Machine Learning course is a 16-week program that progresses from classical ML algorithms through deep learning, NLP, and production deployment. Students build models on real datasets across computer vision, natural language processing, and tabular data domains, graduating with a portfolio of ML projects and deployment experience.',
    ...
    schema: {
      schemaType: 'Course',
      educationalLevel: 'Intermediate',
      teaches: ['Machine Learning', 'Deep Learning', 'TensorFlow', 'NLP', 'MLOps'],
      about: 'Machine Learning and Deep Learning',
    },
    relatedCourseSlugs: ['data-science', 'ai-engineering', 'python-course'],
    canonicalCourseUrl: 'https://arivuon.com/courses/machine-learning',
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    prerequisites: ['Basic Linux command line', 'Familiarity with at least one programming language', 'Basic networking concepts'],
    learningOutcomes: [
    ...
    toolsUsed: ['AWS (EC2, S3, RDS, ECS, Lambda, CloudWatch, IAM)', 'Docker', 'Kubernetes', 'Terraform', 'GitHub Actions', 'Jenkins', 'Ansible', 'Grafana', 'Prometheus'],
    certificationOffered: true,
    certificationName: 'ArivuOn AWS DevOps Certificate',
    certificationProvider: 'ArivuOn Academy',
    syllabus: [
      { order: 1, title: 'AWS Fundamentals', topics: ['AWS global infrastructure', 'EC2, S3, RDS, IAM', 'VPC and security groups', 'AWS CLI and SDKs'], durationHours: 30 },
      { order: 2, title: 'Docker & Containers', topics: ['Container architecture', 'Docker build and run', 'Docker Compose', 'Container registries (ECR)'], durationHours: 25 },
      { order: 3, title: 'Kubernetes', topics: ['K8s architecture', 'Pods, services, deployments', 'Helm charts', 'EKS on AWS'], durationHours: 30 },
      { order: 4, title: 'CI/CD Pipelines', topics: ['GitHub Actions workflows', 'AWS CodePipeline', 'Automated testing in CI', 'Blue-green deployments'], durationHours: 25 },
      { order: 5, title: 'Infrastructure as Code', topics: ['Terraform basics', 'Terraform state and modules', 'Ansible playbooks', 'CloudFormation'], durationHours: 20 },
      { order: 6, title: 'Monitoring & Security', topics: ['CloudWatch metrics and alarms', 'Grafana dashboards', 'IAM best practices', 'Secrets Manager', 'Security audit'], durationHours: 10 },
    ],
  ...
  // ─────────────────────────────────────────────
  {
    ...
    certificationOffered: true,
    certificationName: 'ArivuOn Java Developer Certificate',
    certificationProvider: 'ArivuOn Academy',
    syllabus: [
    ...
    description: 'ArivuOn\'s Java Programming course is a 12-week program from Java fundamentals through Spring Boot application development. The course is specifically aligned to IT services company hiring patterns — where Java and Spring Boot remain the dominant backend stack — giving students a direct pathway to IT services roles at TCS, Infosys, Wipro, Cognizant, and similar employers.',
    ...
    seo: {
      metaTitle: 'Java Programming Course — ArivuOn Academy',
  ...
  // ─────────────────────────────────────────────
  {
    ...
    prerequisites: ['JavaScript fundamentals (ES6+)', 'Basic HTML and CSS', 'Understanding of HTTP and APIs'],
    learningOutcomes: [
    ...
    toolsUsed: ['React 18', 'TypeScript', 'Vite', 'React Router v6', 'React Query', 'Zustand', 'Tailwind CSS', 'React Testing Library', 'Vitest', 'Vercel'],
    certificationOffered: true,
    certificationName: 'ArivuOn React Developer Certificate',
    certificationProvider: 'ArivuOn Academy',
    syllabus: [
      { order: 1, title: 'React Fundamentals', topics: ['JSX and component model', 'Props and state', 'useState, useEffect, useRef', 'Component lifecycle'], durationHours: 25 },
      { order: 2, title: 'Advanced Hooks & State', topics: ['useContext, useReducer, useMemo', 'Custom hooks', 'React Query for data fetching', 'Zustand global state'], durationHours: 25 },
      { order: 3, title: 'TypeScript with React', topics: ['TypeScript fundamentals', 'Typing components and hooks', 'Generic types', 'Type-safe API calls'], durationHours: 20 },
      { order: 4, title: 'Routing & Performance', topics: ['React Router v6', 'Nested and dynamic routes', 'Code splitting and lazy loading', 'Performance optimisation'], durationHours: 20 },
      { order: 5, title: 'Testing & Deployment', topics: ['React Testing Library', 'Vitest setup', 'Component and integration tests', 'Vercel deployment', 'CI with GitHub Actions'], durationHours: 18 },
      { order: 6, title: 'Capstone Project', topics: ['Full React application with TypeScript', 'API integration', 'Testing suite', 'Deployed portfolio project'], durationHours: 12 },
    ],
    ...
    schema: {
      schemaType: 'Course',
      educationalLevel: 'Intermediate',
      teaches: ['React', 'TypeScript', 'Frontend Development', 'React Query', 'Testing'],
      about: 'React Frontend Development',
    },
    relatedCourseSlugs: ['full-stack-development', 'javascript', 'aws-devops'],
    canonicalCourseUrl: 'https://arivuon.com/courses/react',
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    prerequisites: ['Python proficiency', 'Basic ML concepts', 'REST API development experience'],
    learningOutcomes: [
    ...
    toolsUsed: ['Python', 'OpenAI API', 'LangChain', 'LlamaIndex', 'Pinecone', 'ChromaDB', 'HuggingFace', 'FastAPI', 'Docker', 'AWS Bedrock', 'Anthropic Claude API'],
    certificationOffered: true,
    certificationName: 'ArivuOn AI Engineer Certificate',
    certificationProvider: 'ArivuOn Academy',
    syllabus: [
      { order: 1, title: 'LLM Fundamentals', topics: ['Transformer architecture and attention', 'Prompt engineering techniques', 'OpenAI and Anthropic APIs', 'Token economics and context windows'], durationHours: 35 },
      { order: 2, title: 'RAG Systems', topics: ['Vector databases (Pinecone, ChromaDB)', 'Document chunking strategies', 'Embedding models', 'End-to-end RAG pipeline', 'Retrieval evaluation'], durationHours: 40 },
      { order: 3, title: 'AI Agents & Orchestration', topics: ['LangChain agents and tools', 'LlamaIndex workflows', 'ReAct patterns', 'Multi-agent architectures', 'Tool use and function calling'], durationHours: 40 },
      { order: 4, title: 'Fine-tuning & Model Customisation', topics: ['Dataset preparation for fine-tuning', 'LoRA and QLoRA techniques', 'HuggingFace Trainer', 'RLHF basics', 'Model evaluation'], durationHours: 35 },
      { order: 5, title: 'Production AI Systems', topics: ['AI API design with FastAPI', 'Containerised AI deployment', 'LLM monitoring and observability', 'Cost optimisation', 'Responsible AI'], durationHours: 30 },
      { order: 6, title: 'AI Engineering Capstone', topics: ['Build a production AI application', 'RAG or agent-based system', 'Evaluation and deployment', 'Portfolio presentation'], durationHours: 20 },
    ],
    ...
    description: 'ArivuOn\'s AI Engineering course is a 16-week advanced program for developers who want to build production AI applications. Covering LLM APIs, RAG systems, AI agents, fine-tuning, and production deployment, this course positions graduates for the fastest-growing job category in India\'s technology sector — AI/ML engineering with a focus on generative AI and LLM application development.',
    ...
    schema: {
      ...
      teaches: ['AI Engineering', 'LLMs', 'RAG', 'LangChain', 'Generative AI', 'Fine-tuning'],
      about: 'AI Engineering and Large Language Models',
    },
    relatedCourseSlugs: ['machine-learning', 'data-science', 'python-course'],
    canonicalCourseUrl: 'https://arivuon.com/courses/ai-engineering',
  },
];
...
export function getCourseBySlug(slug: string): Course | undefined {
  return courses.find((c) => c.slug === slug && c.status === 'published' && c.offeredAtLocations);
}

export function getAllLocationCourses(): Course[] {
  return courses.filter((c) => c.status === 'published' && c.offeredAtLocations);
}
...
export function getCoursesByCategory(category: string): Course[] {
  return courses.filter(
    (c) => c.category === category && c.status === 'published' && c.offeredAtLocations
  );
}