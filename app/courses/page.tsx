...
export default function CoursesPage() {
  const allCourses = [
    ...
    },
    {
      ...
      level: 'Beginner to Advanced',
      fee: '₹10,000',
      features: ['Django', 'REST APIs', 'Database Design', 'Real Projects', 'Placement Support'],
      popular: true,
    },
    {
      id: 2,
      title: 'DevOps Engineering',
      description: 'Learn CI/CD, Docker, AWS, and infrastructure automation from experts.',
      icon: <CloudCog className="w-8 h-8" />,
      duration: '6 Weeks',
      level: 'Intermediate',
      fee: '₹10,000',
      features: ['Docker', 'AWS Cloud', 'CI/CD Pipeline', 'Terraform', 'Monitoring Tools', 'Cloud Security'],
      popular: true,
    },
    {
      id: 3,
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              ...
              {allCourses.map((course) => (
                ...
                <div
                  key={course.id}
                  className={`group relative bg-white border border-blue-100 rounded-2xl p-8 sm:p-10 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-visible ${course.popular ? "border-blue-500" : ""
                    }`}
                >
