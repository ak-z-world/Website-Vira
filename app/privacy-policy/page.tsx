          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                At ArivuOn Academy, your privacy is important to us. This Privacy Policy explains how we collect, use, and protect your personal information.
              </p>
            </div>
          </div>
        </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <h2 className="text-2xl md:text-3xl font-bold text-gray-900">
                          Privacy Policy – ArivuOn Academy
                        </h2>
                        ...
                        <div className="flex items-start gap-4 p-6 bg-gradient-to-br from-orange-50 to-orange-100/30 rounded-2xl border border-indigo-200">
                          ...
                          <div>
                            ...
                            <p className="text-gray-700 leading-relaxed">
                              At ArivuOn Academy, your privacy is important to us. This Privacy Policy explains how we collect, use, and protect your personal information when you access our website or use our online learning services. By using our website or enrolling in our programs, you agree to the practices described in this policy.
                            </p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="animate-in fade-in duration-300">
                        <div className="p-6 bg-white border border-gray-100 rounded-2xl">
                          ...
                          <div className="space-y-4">
                            <div className="p-4 bg-orange-50 rounded-xl">
                              <p className="text-gray-700">
                                All course content provided by ArivuOn Academy is for personal educational use only.
                              </p>
                            </div>
                    ...
                    {activeSection === 'international' && (
                      <div className="animate-in fade-in duration-300">
                        <div className="p-6 bg-white border border-gray-100 rounded-2xl">
                          ...
                          <div className="p-4 bg-orange-50 rounded-xl">
                            <p className="text-gray-700">
                              ArivuOn Academy operates as a global online learning platform. By using our services from any location worldwide, you consent to the collection and processing of your information in accordance with this Privacy Policy and applicable international data protection regulations.
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    {activeSection === 'contact' && (
                      <div className="animate-in fade-in duration-300">
                        <div className="p-6 bg-white border border-gray-100 rounded-2xl">
                          ...
                          <div className="p-4 bg-orange-50 rounded-xl">
                            <p className="text-gray-700">
                              If you have any questions or concerns regarding this Privacy Policy or how your data is handled, please contact ArivuOn Academy through our official communication channels.
                            </p>
                          </div>
                        </div>
                      </div>
